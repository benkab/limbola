<nav class="navbar navbar-default" id="limbola_navbar">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-right hidden-md hidden-sm hidden-xs">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">LimCrush&nbsp;<span class="caret"></span></a>
        ...
        @if(Auth::check())
            ...
            <li id="connexion">
                <a href="{{route('view_lymstyle_page')}}">
                  <span>Admin</span>
                </a>
            </li>
             @endif
