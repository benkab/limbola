       		...
       		<div class="col-md-4 col-sm-12 col-xs-12">
       			<div class="panel panel-default">
       				<div class="panel-body">
						...
						<form class="form-vertical" action="{{ route('edited_tag', ['id' => $tag->id])}}" method="Post" role="form">
							<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
								<textarea name="description" id="description" rows="3" class="form-control" placeholder="Description">{{ Request::old('description') ?: $tag->description}}</textarea>
